...
class ActorModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        ...
        # modify the chat_template
        if args.apply_chat_template and args.tokenizer_chat_template:
            self.tokenizer.chat_template = args.tokenizer_chat_template
            print(f"chat template is set to {args.tokenizer_chat_template}")
            self.tokenizer.chat_template = self.tokenizer.chat_template
        ...
        actor_scheduler = get_scheduler(
            ...
            scheduler_specific_kwargs={"min_lr": args.actor_learning_rate * args.lr_drop_ratio},
        )
    ...
    def prepare_datasets(self):
        ...
        self.prompts_dataset = PromptDataset(
            prompts_data, self.tokenizer, strategy, input_template=args.input_template, prompt_max_len=args.prompt_max_len
        )
