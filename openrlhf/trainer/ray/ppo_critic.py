...
class CriticModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain, max_steps):
        ...
        if strategy.args.use_inform and '_inform_latent_' in pretrain:
            strategy.print("Info-Critic is activated !!!")
            critic = get_llm_for_sequence_regression_inform(
                pretrain,
                "critic",
            ...
            strategy.print("Standard Critic is activated !!!")
        ...
        critic_scheduler = get_scheduler(
            ...
            scheduler_specific_kwargs={"min_lr": args.critic_learning_rate * args.lr_drop_ratio},
        )
