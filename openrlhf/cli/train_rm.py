...
if __name__ == "__main__":
    ...
    parser.add_argument("--latent_dim", type=int, default=128, help="The IB Dimension on InfoRM")
    parser.add_argument("--kl_loss_coef", type=float, default=0.1, help="the coefficient of kl in IB latent space")
